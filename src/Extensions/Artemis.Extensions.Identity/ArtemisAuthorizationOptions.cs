...
///     Artemis认证选项接口
/// </summary>
file interface IArtemisIdentityOptions
{
    /// <summary>
    ///     上下文项目Token键
    /// </summary>
...
///     传递认证选项
/// </summary>
public class ArtemisIdentityOptions : IArtemisIdentityOptions
{
    ...
    ///     上下文项目Token键
    /// </summary>
    public string ContextItemTokenKey { get; set; } = IdentityShared.Token;

    /// <summary>
    ///     请求头认证Token架构
    /// </summary>
    public string RequestHeaderTokenSchema { get; set; } = IdentityShared.Schema;

    /// <summary>
    ///     请求头Token键
    /// </summary>
    public string RequestHeaderTokenKey { get; set; } = IdentityShared.Token;

    /// <summary>
    ///     缓存Token前缀
    /// </summary>
    public string CacheTokenPrefix { get; set; } = $"{IdentityShared.CacheSpace}:{IdentityShared.Token}";

    /// <summary>
    ///     用户对Token映射缓存键前缀
    /// </summary>
    public string CacheUserMapTokenPrefix { get; set; } = $"{IdentityShared.CacheSpace}:{IdentityShared.UserMapToken}";
    ...
    ///     认证服务对提供者名称
    /// </summary>
    public string IdentityServiceProvider { get; set; } = IdentityShared.DefaultServiceProvider;

    /// <summary>
    ///     认证服务令牌名称后缀
    /// </summary>
    public string IdentityServiceTokenNameSuffix { get; set; } = IdentityShared.Token;
