...
public abstract class Manager<TEntity, TKey> : IManager<TEntity, TKey>, IDisposable where TEntity : IModelBase<TKey> where TKey : IEquatable<TKey>
{
    /// <summary>
    /// 创建新的管理器实例
    /// </summary>
    ...
    /// 配置访问器
    /// </summary>
    private IStoreOptions StoreOptions { get; set; }
