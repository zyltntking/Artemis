...
///     系统模块存储接口
/// </summary>
public interface IArtemisSystemModuleStore : IStore<ArtemisSystemModule>;
...
///     系统模块存储
/// </summary>
public class ArtemisSystemModuleStore : Store<ArtemisSystemModule>, IArtemisSystemModuleStore
{
    /// <summary>
    ///     基本存储实例构造
    /// </summary>
    ...
    public ArtemisSystemModuleStore(
