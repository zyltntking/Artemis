...
///     教师学生关系对应实体配置
/// </summary>
internal sealed class ArtemisTeacherStudentConfiguration : BaseEntityConfiguration<ArtemisTeacherStudent>
{
    ...
    ///     数据集描述
    /// </summary>
    protected override string DataSetDescription => "教师学生映射数据集";

    /// <summary>
    ///     表名
    /// </summary>
    protected override string TableName => nameof(ArtemisTeacherStudent);
    ...
    /// </summary>
    /// <param name="builder"></param>
    protected override void EntityRelationConfigure(EntityTypeBuilder<ArtemisTeacherStudent> builder)
    {
