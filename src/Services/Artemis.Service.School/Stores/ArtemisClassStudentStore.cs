...
///     班级学生关系存储接口
/// </summary>
public interface IArtemisClassStudentStore : IKeyLessStore<ArtemisClassStudent>;
...
///     班级学生关系存储
/// </summary>
public sealed class ArtemisClassStudentStore : KeyLessStore<ArtemisClassStudent>, IArtemisClassStudentStore
{
    /// <summary>
    ///     无键模型基本存储实例构造
    /// </summary>
    ...
    public ArtemisClassStudentStore(
