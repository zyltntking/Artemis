...
///     班级存储接口
/// </summary>
public interface IArtemisTeacherChangeLogStore : IStore<ArtemisTeacherChangeLog>;
...
///     班级存储
/// </summary>
public sealed class ArtemisTeacherChangeLogStore : Store<ArtemisTeacherChangeLog>, IArtemisTeacherChangeLogStore
{
    /// <summary>
    ///     基本存储实例构造
    /// </summary>
    ...
    public ArtemisTeacherChangeLogStore(
