...
///     班级存储接口
/// </summary>
public interface IArtemisStudentChangeLogStore : IStore<ArtemisStudentChangeLog>;
...
///     班级存储
/// </summary>
public sealed class ArtemisStudentChangeLogStore : Store<ArtemisStudentChangeLog>, IArtemisStudentChangeLogStore
{
    /// <summary>
    ///     基本存储实例构造
    /// </summary>
    ...
    public ArtemisStudentChangeLogStore(
