...
internal class SenderPool : Pool<Sender>
{
    ...
    protected override Sender Create() => new();

    /// <summary>
    ///     重置连接
    /// </summary>
    /// <param name="connection">连接对象</param>
    protected override void Reset(Sender connection) => connection.Reset();

    /// <summary>
    ///     释放连接
    /// </summary>
    /// <param name="connection">连接对象</param>
    protected override void Release(Sender connection) => connection.Dispose();
