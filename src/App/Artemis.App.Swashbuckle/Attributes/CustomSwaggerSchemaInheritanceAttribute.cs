...
public class CustomSwaggerSchemaInheritanceAttribute : Attribute
{
    ...
    public CustomSwaggerSchemaInheritanceAttribute(string externalSchemaName, string[] notInheritedPropertiesName,
        CommonObjectType definitionLevel = CommonObjectType.ResourceProviderCommonDefinition)
    {
    ...
    ///     模式描述格式
    /// </summary>
    public string SchemaDescriptionFormat { get; }
}