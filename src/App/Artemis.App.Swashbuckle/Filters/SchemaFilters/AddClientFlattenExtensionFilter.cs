    ...
    public void Apply(OpenApiSchema schema, SchemaFilterContext context)
    {
        ...
        if (flattenAttr != null)
        {
            ...
            if (propertyToAddFlattern.Reference != null)
            {
                ...
                propertyToAddFlattern.Extensions.Add("$ref",
                    new OpenApiString(origRef.ExternalResource ?? origRef.ReferenceV2));
            }

            schema.Properties[flattenAttr.PropertyName].Extensions
                .TryAdd("x-ms-client-flatten", new OpenApiBoolean(true));
        }
    }
}