...
public class AddReadOnlyPropertyFilter : ISchemaFilter
{
    ...
    public void Apply(OpenApiSchema schema, SchemaFilterContext context)
    {
        ...
        if (readOnlyAttr is { IsReadOnlyProperty: true }) schema.ReadOnly = true;
        ...
        foreach (var schemaProperty in schema.Properties)
        {
            ...
            try
            {
                property = context.Type.GetProperty(schemaProperty.Key,
            ...
            {
                var attr =
                    property.GetCustomAttributes(typeof(ReadOnlyPropertyAttribute), false).SingleOrDefault() as
                        ReadOnlyPropertyAttribute;
                if (attr is { IsReadOnlyProperty: true }) schemaProperty.Value.ReadOnly = true;
            }
        }
    }
}