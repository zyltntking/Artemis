        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true, comment: "任务编码"),
                    DesignCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true, comment: "设计编码"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true, comment: "单元编码"),
                    DesignCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true, comment: "设计编码"),
                    TaskUnitState = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false, comment: "任务状态"),
