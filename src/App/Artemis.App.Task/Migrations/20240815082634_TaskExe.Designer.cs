...
namespace Artemis.App.Task.Migrations
{
    ...
    [Migration("20240815082634_TaskExe")]
    partial class TaskExe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artemis.Service.Task.Context.ArtemisTask", b =>
                {
                    ...
                    b.HasIndex("DesignCode")
                        .HasDatabaseName("IX_ArtemisTask_DesignCode");
                    ...
                    b.HasIndex("TaskCode")
                        .HasDatabaseName("IX_ArtemisTask_TaskCode");
                    ...
                    b.HasIndex("TaskState")
                        .HasDatabaseName("IX_ArtemisTask_TaskState");
            ...
            modelBuilder.Entity("Artemis.Service.Task.Context.ArtemisTaskUnit", b =>
                {
                    ...
                    b.Property<string>("TaskUnitMode")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasComment("任务模式");

                    b.Property<string>("TaskUnitState")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasComment("任务状态");
                    ...
                    b.HasIndex("DesignCode")
                        .HasDatabaseName("IX_ArtemisTaskUnit_DesignCode");

                    b.HasIndex("EndTime")
                        .HasDatabaseName("IX_ArtemisTaskUnit_EndTime");

                    b.HasIndex("ModifyBy")
                        .HasDatabaseName("IX_ArtemisTaskUnit_ModifyBy");

                    b.HasIndex("NormalizedUnitName")
                        .HasDatabaseName("IX_ArtemisTaskUnit_UnitName");

                    b.HasIndex("RemoveBy")
                        .HasDatabaseName("IX_ArtemisTaskUnit_RemoveBy");

                    b.HasIndex("StartTime")
                        .HasDatabaseName("IX_ArtemisTaskUnit_StartTime");

                    b.HasIndex("TaskId");

                    b.HasIndex("TaskUnitMode")
                        .HasDatabaseName("IX_ArtemisTaskUnit_TaskUnitMode");

                    b.HasIndex("TaskUnitState")
                        .HasDatabaseName("IX_ArtemisTaskUnit_TaskUnitState");

                    b.HasIndex("UnitCode")
                        .HasDatabaseName("IX_ArtemisTaskUnit_UnitCode");
            ...
            modelBuilder.Entity("Artemis.Service.Task.Context.ArtemisTaskUnitTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("标识");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ArtemisTaskUnitTarget");

                    b.HasIndex("CreateBy")
                        .HasDatabaseName("IX_ArtemisTaskUnitTarget_CreateBy");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_ArtemisTaskUnitTarget_CreatedAt");

                    b.HasIndex("DeletedAt")
                        .HasDatabaseName("IX_ArtemisTaskUnitTarget_DeletedAt");

                    b.HasIndex("ModifyBy")
                        .HasDatabaseName("IX_ArtemisTaskUnitTarget_ModifyBy");

                    b.HasIndex("RemoveBy")
                        .HasDatabaseName("IX_ArtemisTaskUnitTarget_RemoveBy");

                    b.HasIndex("TaskUnitId");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_ArtemisTaskUnitTarget_UpdatedAt");

                    b.ToTable("ArtemisTaskUnitTarget", "Task", t =>
                        {
            ...
            modelBuilder.Entity("Artemis.Service.Task.Context.ArtemisTaskUnitTarget", b =>
                {
                    b.HasOne("Artemis.Service.Task.Context.ArtemisTaskUnit", "TaskUnit")
                        .WithMany("TaskUnitTargets")
                        .HasForeignKey("TaskUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ArtemisTaskUnitTarget_ArtemisTaskUnit");
