        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "购买日期"),
                    InstallDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "安装日期"),
                    WarrantyDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "保修日期"),
                    MaintenanceDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "维护日期"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstablishTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "机构成立时间"),
