...
namespace Artemis.App.Identity.Migrations
{
    ...
    [Migration("20240624170243_ChangeIdentityClaimModel")]
    partial class ChangeIdentityClaimModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityRoleClaim", b =>
                {
                    ...
                    b.HasIndex("CheckStamp")
                        .IsUnique()
                        .HasDatabaseName("IX_IdentityRoleClaim_CheckStamp");
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityUserClaim", b =>
                {
                    ...
                    b.HasIndex("CheckStamp")
                        .IsUnique()
                        .HasDatabaseName("IX_IdentityUserClaim_CheckStamp");
