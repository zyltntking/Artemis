...
namespace Artemis.App.Identity.Migrations
{
    ...
    [Migration("20240725010702_InitialIdentity")]
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47610070-84d0-4638-a5d1-b40e19cf9d5a"),
                            ConcurrencyStamp = "d6b238c5-f0a3-4254-8928-d4fee3f68b4c",
                            CreateBy = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2024, 7, 25, 9, 7, 2, 384, DateTimeKind.Local).AddTicks(1443),
                            Description = "默认管理员",
                            ModifyBy = "00000000-0000-0000-0000-000000000000",
                            Name = "Admin",
                            NormalizedName = "Admin",
                            UpdatedAt = new DateTime(2024, 7, 25, 9, 7, 2, 384, DateTimeKind.Local).AddTicks(1463)
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("58510b95-1bf6-4d24-9b2b-e71bdf550a73"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e8121291-cd1e-4063-933b-d74e793246a0",
                            CreateBy = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2024, 7, 25, 9, 7, 2, 384, DateTimeKind.Local).AddTicks(1682),
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            ModifyBy = "00000000-0000-0000-0000-000000000000",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAQABAeCAAAAEAWMpbNE093jCa58ROOANUCRejUrt//+t+4aBJJ5OpDLYU3gcS5XhbA4WTtmt4p80YchOq2O",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "AMEVUIDINGYGJRPIT4K6I43DOCMD7HUK",
                            TwoFactorEnabled = false,
                            UpdatedAt = new DateTime(2024, 7, 25, 9, 7, 2, 384, DateTimeKind.Local).AddTicks(1682),
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("58510b95-1bf6-4d24-9b2b-e71bdf550a73"),
                            RoleId = new Guid("47610070-84d0-4638-a5d1-b40e19cf9d5a")
                        });
                });
