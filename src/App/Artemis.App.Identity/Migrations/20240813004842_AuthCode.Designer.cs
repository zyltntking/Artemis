...
namespace Artemis.App.Identity.Migrations
{
    ...
    [Migration("20240813004842_AuthCode")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityAuthCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("标识");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_IdentityAuthCode");

                    b.HasIndex("Code")
                        .HasDatabaseName("IX_IdentityAuthCode_Code");

                    b.HasIndex("CreateBy")
                        .HasDatabaseName("IX_IdentityAuthCode_CreateBy");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_IdentityAuthCode_CreatedAt");

                    b.HasIndex("DeletedAt")
                        .HasDatabaseName("IX_IdentityAuthCode_DeletedAt");

                    b.HasIndex("ModifyBy")
                        .HasDatabaseName("IX_IdentityAuthCode_ModifyBy");

                    b.HasIndex("RemoveBy")
                        .HasDatabaseName("IX_IdentityAuthCode_RemoveBy");

                    b.HasIndex("SendTime")
                        .HasDatabaseName("IX_IdentityAuthCode_SendTime");

                    b.HasIndex("Sign")
                        .HasDatabaseName("IX_IdentityAuthCode_Sign");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_IdentityAuthCode_UpdatedAt");

                    b.HasIndex("Used")
                        .HasDatabaseName("IX_IdentityAuthCode_Used");

                    b.ToTable("IdentityAuthCode", "Identity", t =>
                        {
                            t.HasComment("认证验证码数据集");
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9fb37c76-adba-4c50-af0f-c762b0b88b3b"),
                            ConcurrencyStamp = "eadd647a-c915-4e55-90f8-8b73853d2402",
                            CreateBy = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2024, 8, 13, 8, 48, 41, 833, DateTimeKind.Local).AddTicks(263),
                            Description = "默认管理员",
                            ModifyBy = "00000000-0000-0000-0000-000000000000",
                            Name = "Admin",
                            NormalizedName = "Admin",
                            UpdatedAt = new DateTime(2024, 8, 13, 8, 48, 41, 833, DateTimeKind.Local).AddTicks(284)
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6343b1ad-b266-4b63-a49a-031e9c05031b"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4a43dd94-83af-4e49-b131-f5aa5693f5a3",
                            CreateBy = "00000000-0000-0000-0000-000000000000",
                            CreatedAt = new DateTime(2024, 8, 13, 8, 48, 41, 833, DateTimeKind.Local).AddTicks(522),
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            ModifyBy = "00000000-0000-0000-0000-000000000000",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAQAAs20AAAAGfcyBMWpBZDibnS6QYq54MpSTN4twupyrjQ6x20i4+jGwVDQn3jlsroGnLCsIU59BlBeVzBxcpcTNrAP",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "36O3ANAVTZNTQEPUHVI6ECK5IX73CVCM",
                            TwoFactorEnabled = false,
                            UpdatedAt = new DateTime(2024, 8, 13, 8, 48, 41, 833, DateTimeKind.Local).AddTicks(522),
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Identity.Context.IdentityUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6343b1ad-b266-4b63-a49a-031e9c05031b"),
                            RoleId = new Guid("9fb37c76-adba-4c50-af0f-c762b0b88b3b")
                        });
                });
