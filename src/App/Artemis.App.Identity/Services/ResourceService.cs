...
public class ResourceService : Resource.ResourceBase
{
    ...
    public override async Task<SearchClaimInfoResponse> SearchClaimInfo(SearchClaimInfoRequest request, ServerCallContext context)
    {
    ...
    /// <returns>The response to send back to the client (wrapped by a task).</returns>
    [Authorize(IdentityPolicy.Token)]
    public override async Task<ReadClaimInfoResponse> ReadClaimInfo(ReadClaimInfoRequest request, ServerCallContext context)
    {
