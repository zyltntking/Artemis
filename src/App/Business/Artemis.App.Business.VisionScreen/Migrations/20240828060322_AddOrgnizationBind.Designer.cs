...
namespace Artemis.App.Business.VisionScreen.Migrations
{
    ...
    [Migration("20240828060322_AddOrgnizationBind")]
    partial class AddOrgnizationBind
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artemis.Service.Business.VisionScreen.Context.ArtemisOptometer", b =>
                {
                    ...
                    b.Property<double?>("LeftHorizontalAxis")
                        .HasColumnType("double precision")
                        .HasComment("左眼水平方向斜视度数");

                    b.Property<double?>("LeftPupilRadius")
                        .HasColumnType("double precision")
                        .HasComment("左眼瞳孔半径");

                    b.Property<double?>("LeftRedReflect")
                        .HasColumnType("double precision")
                        .HasComment("左眼红光反射");
                    ...
                    b.Property<double?>("LeftVerticalAxis")
                        .HasColumnType("double precision")
                        .HasComment("左眼垂直方向斜视度数");
                    ...
                    b.Property<double?>("RightHorizontalAxis")
                        .HasColumnType("double precision")
                        .HasComment("右眼水平方向斜视度数");

                    b.Property<double?>("RightPupilRadius")
                        .HasColumnType("double precision")
                        .HasComment("右眼瞳孔半径");

                    b.Property<double?>("RightRedReflect")
                        .HasColumnType("double precision")
                        .HasComment("右眼红光反射");
                    ...
                    b.Property<double?>("RightVerticalAxis")
                        .HasColumnType("double precision")
                        .HasComment("右眼垂直方向斜视度数");
            ...
            modelBuilder.Entity("Artemis.Service.Business.VisionScreen.Context.ArtemisOrganizationUsersBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("标识");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ArtemisOrganizationUsersBinding");

                    b.HasIndex("CreateBy")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_CreateBy");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_CreatedAt");

                    b.HasIndex("DeletedAt")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_DeletedAt");

                    b.HasIndex("ModifyBy")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_ModifyBy");

                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("OrganizationId");

                    b.HasIndex("Partition")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_Partition");

                    b.HasIndex("RemoveBy")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_RemoveBy");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_UpdatedAt");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_ArtemisOrganizationUsersBinding_UserId");

                    b.ToTable("ArtemisOrganizationUsersBinding", "Business", t =>
                        {
                            t.HasComment("机构用户关系绑定数据集");
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Business.VisionScreen.Context.ArtemisStudentRelationBinding", b =>
                {
                    ...
                    b.HasIndex("StudentId")
                        .HasDatabaseName("StudentId");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_ArtemisStudentRelationBinding_UpdatedAt");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_ArtemisStudentRelationBinding_UserId");
            ...
            modelBuilder.Entity("Artemis.Service.Business.VisionScreen.Context.ArtemisTeacherUserBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("标识");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ArtemisTeacherUserBinding");

                    b.HasIndex("CreateBy")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_CreateBy");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_CreatedAt");

                    b.HasIndex("DeletedAt")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_DeletedAt");

                    b.HasIndex("ModifyBy")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_ModifyBy");

                    b.HasIndex("Partition")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_Partition");

                    b.HasIndex("RemoveBy")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_RemoveBy");

                    b.HasIndex("TeacherId")
                        .IsUnique()
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_TeacherId");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_ArtemisTeacherUserBinding_UpdatedAt");

                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("UserId");

                    b.ToTable("ArtemisTeacherUserBinding", "Business", t =>
                        {
                            t.HasComment("用户教师绑定数据集");
                        });
                });
            ...
            modelBuilder.Entity("Artemis.Service.Business.VisionScreen.Context.ArtemisVisionScreenRecord", b =>
                {
                    ...
                    b.Property<DateTime?>("UserSignTime")
                        .HasColumnType("TIMESTAMP")
                        .HasComment("用户签名时间");
